...
services["Seahub"]="seahub"
services["Prosody"]="prosody"
services["Coturn"]="coturn"
services["MiniDLNA"]="minidlna"
services["qB-nox"]="qbittorrent-nox"
services["Amavis"]="amavis"
services["Postfix"]="postfix"
services["iRedAPD"]="iredapd"
services["Mlmmj"]="mlmmjadmin"
services["iRedAdmin"]="iredadmin"
services["Dovecot"]="dovecot"
services["Samba"]="smbd"
services["iSCSI-T"]="tgt"
services["LIO-Targetcli-FB"]="targetclid"
services["NFS-Server"]="nfs-kernel-server"
services["Lighttpd"]="lighttpd"
services["Pi-Hole"]="pihole-FTL"
services["DoH"]="cloudflared"
services["Suricata"]="suricata"
services["Mikrocata"]="mikrocata"
